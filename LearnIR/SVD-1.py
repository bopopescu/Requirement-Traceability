...
trace_open = "../DataSet/UseCase1.TXT"
trace_save = "../DataSet/svd_result1.txt"
txt = f_file_open(trace_open)
word_vector = f_vector_found(txt)
print ("word_vector length:",len(word_vector))
...
print ("len(document_matric_U[1]):",len(document_matric_U[1]))
print ("len(document_matric_V):",len(document_matric_V))
